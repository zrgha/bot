    ...
    for update in updates:
        ...
        if "message" in update:
            ...
            if text == "/start":
                ...
                try:
                    ...
                    if 1 <= qty <= 10:
                        if stock.get(qty, 0) > 0:
                            ...
                            pending_purchase[chat_id] = {"qty": qty, "awaiting_receipt": True}
                            ...
                            send_message(chat_id, f"Sorry, {qty} zero(s) are out of stock. Please choose a different quantity.", main_menu())
                            del pending_purchase[chat_id]
                    else:
                ...
                send_message(chat_id,
                    f"Your order for {qty} zero(s) has been submitted!\n"
                    f"Please contact the admin {ADMIN_USERNAME} in private to receive your accounts.\n"
